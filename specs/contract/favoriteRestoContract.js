...
const itActsFavoriteRestoModel = (favoriteResto) => {
  ...
  it('Should refuse a resto being added if it does not have the correct property', async () => {
...
export { itActsFavoriteRestoModel };
